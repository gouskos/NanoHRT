...
class PhotonSampleProducer(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("ak8_1_bestB" , "F")
        self.out.branch("ak8_1_bestH" , "F")
        self.out.branch("ak8_1_bestQCD" , "F")
        self.out.branch("ak8_1_bestT" , "F")
        self.out.branch("ak8_1_bestW" , "F")
        self.out.branch("ak8_1_bestZ" , "F")
    ...
    def _fillEventInfo(self, event):
        ...
        self.out.fillBranch("ak8_1_bestB" , event.ak8jets[0].bestB)
        self.out.fillBranch("ak8_1_bestH" , event.ak8jets[0].bestH)
        self.out.fillBranch("ak8_1_bestQCD" , event.ak8jets[0].bestQCD)
        self.out.fillBranch("ak8_1_bestT" , event.ak8jets[0].bestT)
        self.out.fillBranch("ak8_1_bestW" , event.ak8jets[0].bestW)
        self.out.fillBranch("ak8_1_bestZ" , event.ak8jets[0].bestZ)
